...
public class ConfiguracaoDeSeguranca {
    ...
    public ConfiguracaoDeSeguranca(
            @org.springframework.beans.factory.annotation.Value("${mirante.origens-permitidas:http://localhost:3000}")
            String origens) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Mirante-Tenant",
                "X-Mirante-Dispositivo", "X-Mirante-Perfil"));
        config.setExposedHeaders(List.of("X-Mirante-Requisicao"));

package br.com.mirante.infrastructure.billing;
...
public class GatewayAsaas implements GatewayDePagamento {
    ...
    private final ConfiguracaoDoMirante.Cobranca config;
    private final Clock relogio;

    public GatewayAsaas(ConfiguracaoDoMirante.Cobranca config, ObjectMapper json, Clock relogio) {
        this.config = config;
        this.json = json;

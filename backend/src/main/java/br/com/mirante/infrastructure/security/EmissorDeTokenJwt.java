...
public class EmissorDeTokenJwt implements EmissorDeToken {
    ...
    private static final String EMISSOR = "mirante";
    ...
    private final ConfiguracaoDoMirante.Autenticacao config;
    private final JdbcClient jdbc;
    private final Clock relogio;

    public EmissorDeTokenJwt(ConfiguracaoDoMirante configuracao, JdbcClient jdbc, Clock relogio) {

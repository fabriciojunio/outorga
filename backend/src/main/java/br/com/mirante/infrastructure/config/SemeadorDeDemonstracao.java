...
public class SemeadorDeDemonstracao {
    ...
    @Bean
    public ApplicationRunner semearDemonstracao(ConfiguracaoDoMirante configuracao,
        ...
        return args -> {
            ...
            var operador = Usuario.criar(tenant.id(), new Email("plataforma@mirante.app"), senha,
                    "Operacao Mirante", Set.of(Papel.ADMIN_PLATAFORMA), agora).valorOuFalha();
            ...
            log.info("""
                    Carga de demonstracao pronta.
                      ...
                      operacao da plataforma: plataforma@mirante.app

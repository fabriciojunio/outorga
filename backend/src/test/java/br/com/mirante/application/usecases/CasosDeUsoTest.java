package br.com.mirante.application.usecases;

import br.com.mirante.application.Auditor;
import br.com.mirante.application.CenarioDeTeste;
import br.com.mirante.application.Dubles;
...
import br.com.mirante.application.usecases.billing.ProcessarEventoDeCobranca;
...
import br.com.mirante.application.usecases.identity.AutenticarUsuario;
import br.com.mirante.application.usecases.playback.AutorizarReproducao;
...
import br.com.mirante.domain.billing.StatusDaAssinatura;
...
import br.com.mirante.domain.playback.PoliticaDeReproducao;
...
class CasosDeUsoTest {
    ...
    class DaVarredura {
        ...
        void devolveAoArQuandoRenova() {
            ...
            var renovada = br.com.mirante.domain.rights.Licenca.reconstituir(
                    ...
                    new br.com.mirante.domain.rights.JanelaDeLicenca(
                    ...
                    br.com.mirante.domain.rights.StatusDaLicenca.VIGENTE, null);
    ...
    class DaAssinatura {
        ...
        void aplicaCupom() {
            cenario.assinaturas.dados.clear();
            cenario.cupons.salvar(br.com.mirante.domain.billing.Cupom
    ...
    class DoIsolamento {
        ...
        void naoVazaEntreClientes() {
            var outroTenant = br.com.mirante.domain.tenant.Tenant.abrir("outra", "Outra TV", null,
        ...
        void naoPublicaComLicencaAlheia() {
            var outroTenant = br.com.mirante.domain.tenant.Tenant.abrir("outra", "Outra TV", null,
                    null, CenarioDeTeste.AGORA).valorOuFalha();
            cenario.tenants.salvar(outroTenant);
            var licencaAlheia = br.com.mirante.domain.rights.Licenca.cadastrar(outroTenant.id(),
                    "Alheia", "CT-Z", Set.of(br.com.mirante.domain.rights.Territorio.BRASIL),
                    br.com.mirante.domain.rights.JanelaDeLicenca.aPartirDe(
